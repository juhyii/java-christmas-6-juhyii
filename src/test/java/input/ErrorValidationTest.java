...
class ErrorValidationTest {
	...
	void testValidateDateRange(String input) {
		assertThatThrownBy(() -> ErrorValidation.validateDate("32"))
	...
	void testValidateDateInteger(String input) {
		assertThatThrownBy(() -> ErrorValidation.validateDate(input))
			.isInstanceOf(IllegalArgumentException.class);
	}
	...
	void testValidateOrderFormatComma(String input) {
		assertThatThrownBy(() -> ErrorValidation.validateOrderFormat(input))
			.isInstanceOf(IllegalArgumentException.class);
	}
	...
	void testValidateMenusZero(String input) {
		...
		assertThatThrownBy(() -> ErrorValidation.validateMenus(testmenu))
			.isInstanceOf(IllegalArgumentException.class);
	}
